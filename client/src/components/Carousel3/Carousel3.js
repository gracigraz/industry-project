...
function Carousel3({ cruiseOne, cruiseTwo }) {
  cruiseOne = useParams();
  cruiseTwo = useParams();
      ...
      <section>
        <figure className="carousel">
          ...
          <div className="carousel-card">
            <h2 className="carousel-card__subtitle">ACCESS</h2>
            ...
            <div className="carousel-paragraph">
              <h2 className="carousel-paragraph__text">CoCoCay resort</h2>
            ...
            <div className="carousel-paragraph">
              <h2 className="carousel-paragraph__text">6 hour port stop</h2>
            ...
            <div className="carousel-paragraph">
              <h2 className="carousel-paragraph__text">Excursions available</h2>
